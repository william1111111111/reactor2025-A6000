# Adapted from https://github.com/fudan-generative-vision/hallo/blob/main/hallo/models/wav2vec.py
# Original author: Fusion Lab: Generative Vision Lab of Fudan University
# License: MIT License
...
class Wav2VecModel(Wav2Vec2Model):
    ...
    def forward(
        ...
        print(f"Linear interpolation from original length {extract_features.shape[1]} to {seq_len}")
